...
public class BlackjackGameTest {
    ...
    public void testPlayerAlwaysTakesCard() {
        ...
        assertTrue(game.getStats().contains("1:0")
            || game.getStats().contains("0:1") || game.getStats().contains("0:0"));
    ...
    public void testPlayerNeverTakesCard() {
        ...
        if (game.getStats().contains("0:0")) {
            ...
            if ((game.getDealer().getScore() > 17)
                && (game.getDealer().getScore() <= 21) && (game.getDealer().getScore() != 21)) {
            ...
            if ((game.getDealer().getScore() > 17)
                && (game.getDealer().getScore() <= 21) && (game.getPlayer().getScore() != 21)) {
                assertTrue((game.getDealer().getScore()) > (game.getPlayer().getScore()));
            } else {
                assertTrue((game.getDealer().getScore() == 21));
            }
